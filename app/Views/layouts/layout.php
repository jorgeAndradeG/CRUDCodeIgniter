    ...
    <section class="header">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="<?=base_url('index.php/usuarios')?>">Lista de Usuarios</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link" href="<?=base_url('index.php/nuevoUsuario')?>">Nuevo Usuario</a>
                    </li>
                    <li class="nav-item">
